        ...
        <>
            <div className="d-flex position-relative item">
                ...
                <div id="container">
                    ...
                    <h3>Our location</h3>
                    <p>House-32, Rd-5, Dhanmondi, Dhaka-1207, Bangladesh.</p>
                </div>
                <hr />
                <div className="my-5">
            ...
            <div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d7301.976418387336!2d90.3730888!3d23.7834342!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1637157000659!5m2!1sen!2sbd" style={{ width: "1200px", height: "300px" }} title="map">
                </iframe>
            </div>
        </>
    );
