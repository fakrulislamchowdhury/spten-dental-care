...
import './Blog.css';
// import blog1 from '../../img/blog/blog-1.jpeg';
    ...
    return (
        <Container className='blog-list'>
            <div className='blog'>
                ...
                <div>
                    <img className='blog' src={"https://i.ibb.co.com/bzJvLwH/blog-1.jpg"} alt="Img" />
                ...
                <div>
                    <img className='blog' src={"https://i.ibb.co.com/37nfTdm/blog-2.png"} alt="Img" />
                ...
                <div>
                    <img className='blog' src={"https://i.ibb.co.com/qjDSvBq/blog-3.jpg"} alt="Img" />
                ...
                <div>
                    <img className='blog' src={"https://i.ibb.co.com/ZTCswg1/blog-4.jpg"} alt="Img" />
                ...
                <div>
                    <img className='blog' src={"https://i.ibb.co.com/gPgJYF1/blog-5.jpg"} alt="Img" />
